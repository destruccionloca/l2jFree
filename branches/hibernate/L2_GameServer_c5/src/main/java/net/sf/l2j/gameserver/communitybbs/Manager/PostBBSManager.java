...
public class PostBBSManager extends BaseBBSManager
{
	...
	{
		_Instance.setForumService((ForumService)(L2Registry.getBean("ForumService")));
	}
	/**
	 * @param service
	 */
	private void setForumService(ForumService service)
	{
	...
	{		
		...
		html.append("<td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"Write Post "+forum.getForumId()+";"+topic.getTopicId()+";0 _ Content Content Content\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\" ></td>");
	...
	{
		//		
		Set<Posts> posts = topic.getPostses();
		Posts firstPost = (Posts)posts.toArray()[0];
		...
		html.append("<td><font color=\"AAAAAA\">"+dateFormat.format(firstPost.getPostDate())+"</font></td>");
		html.append("</tr>");
		html.append("<tr><td height=10></td></tr>");
		html.append("</table>");
		html.append("<br>");
		...
		html.append("<tr>");
		html.append("<td fixwidth=5></td>");
		String Mes = firstPost.getPostTxt().replace(">","&gt;");
		Mes = Mes.replace("<","&lt;");
		Mes = Mes.replace("\n","<br1>");
		...
		html.append("<td FIXWIDTH=300></td><td><button value = \"&$424;\" action=\"bypass _bbsposts;edit;"+ forum.getForumId() +";"+ topic.getTopicId() +";0\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\" ></td>&nbsp;");
