   ...
   /**
    ...
    private SkillTreeTable()
    {
        ...
        try
        {
            ...
            PreparedStatement statement = con.prepareStatement("SELECT skill_id, level, name, base_lvl, sp, min_skill_lvl, exp, success_rate FROM enchant_skill_trees ORDER BY skill_id, level");
