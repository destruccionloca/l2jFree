...
/**
 * This interface defines methods that are known by the ELAYNE administration
 * tool and the L2J Game Server. This interface is the way Elayne and the Game
...
public interface IRemoteAdministration extends Remote
{
	...
	/**
	 * Perform an announcement in game that is broadcasted to every online
	 * player.
	 * @param announcement --> The announcement that is broadcasted inside the
	 * server.
	 * @throws RemoteException
	 */
	...
	/**
	 * This method returns a map containing the information of all the players
	 * online at one particular moment.<br>
	 * For each key (String containing the name of a player), this method
	 * returns an Array of Strings following the object model of the
	 * L2CharacterBriefEntry class.
	 * @return a map containing brief information of all the online players at a
	 * given moment.
	 * @throws RemoteException
	 */
	...
	/**
	 * This method allows an ELAYNE user to hand out an item to any online
	 * server player. Maybe some extended work on this may be needed to allow
	 * RMI to add/delete items on players that are NOT online at any given
	 * moment. Therefore, the only requirement for this to work is that RMI is
	 * allowed. That will be the only way we'll be adding / deleting items in
	 * the future. TODO: Modify comment when implementation has been completed.
	 * @param rmiPassword
	 * @param playerName
	 * @param itemId
	 * @return the objectId of the new item. If the item has not been awarded,
	 * return 0.
	 * @throws RemoteException
	 */
	public int awardItemToPlayer(String rmiPassword, String playerName, int itemId) throws RemoteException;

	/**
	 * This method allows an ELAYNE user to delete an item from any online
	 * player. TODO: modify comment when implementation has been completed.
	 * @param rmiPassword
	 * @param playerName
	 * @param itemObjectId
	 * @return true if the item has been successfully deleted, false else.
	 * @throws RemoteException
	 */
	public boolean deleteItemFromPlayer(String rmiPassword, String playerName, int itemObjectId) throws RemoteException;
}
