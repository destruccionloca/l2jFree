...
final class DocumentSkill extends DocumentBase {
    ...
    private void makeSkills()
    {
        ...
        for (int i=0; i < _currentSkill.enchsets3.length; i++)
        {
            ...
            {
                _log.fatal( "Skill id="+_currentSkill.enchsets3[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets3[i]).getDisplayId()+" level="+_currentSkill.enchsets3[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets3[i]).getLevel(), e);
            }
        }
        _count = count;
        for (int i=0; i < _currentSkill.enchsets4.length; i++)
        {
            ...
            {
                _log.fatal( "Skill id="+_currentSkill.enchsets4[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets4[i]).getDisplayId()+" level="+_currentSkill.enchsets4[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets4[i]).getLevel(), e);
            }
        }
        _count = count;
        for (int i=0; i < _currentSkill.enchsets5.length; i++)
        {
            ...
            {
                _log.fatal( "Skill id="+_currentSkill.enchsets5[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets5[i]).getDisplayId()+" level="+_currentSkill.enchsets5[i].getEnum("skillType", SkillType.class).makeSkill(_currentSkill.enchsets5[i]).getLevel(), e);
            }
        }
    }
}
