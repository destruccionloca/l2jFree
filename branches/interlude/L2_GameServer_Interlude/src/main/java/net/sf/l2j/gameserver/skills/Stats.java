...
public enum Stats {
	...
	public static Stats valueOfXml(String name)
	{
		...
		if (name == "shldAngle") return SHIELD_ANGLE;
		...
		if (name == "poleAngle"    ) return POLE_ATTACK_ANGLE;
        ...
        if (name == "pDef-valakas"  ) return PDEF_VALAKAS;         
        if (name == "pAtk-valakas"  ) return PATK_VALAKAS;
        
        //C5 Stats
        if (name == "absorbHpPercent") return ABSORB_DAMAGE_PERCENT; // TODO: ?_? whats the difference to absorbDam
        if (name == "absorbCpPercent") return ABSORB_CP_PERCENT;
