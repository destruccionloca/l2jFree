...
/**
 * 
 * Class for unit testing hibernate DAO. This class provides automatic startup
 * and shutdown of derby in setup and teardown. It use dynamic generation of
 * configuration and use dbunit to set up database.
 */
public abstract class ADAOTestCase extends AHibernateTestCase {
	...
	public void setUpDBUnit() throws Exception {
		...
		connection = new DatabaseConnection(DerbyHelper.getConnection(),
				DerbyHelper.USER);
