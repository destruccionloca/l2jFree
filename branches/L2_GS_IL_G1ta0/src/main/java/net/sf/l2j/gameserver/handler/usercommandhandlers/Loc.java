...
public class Loc implements IUserCommandHandler
{
    ...
    public boolean useUserCommand(@SuppressWarnings("unused") int id, L2PcInstance activeChar)
    {
    	...
    	SystemMessageId msg = SystemMessageId.S1_S2;
    	SystemMessage sm = new SystemMessage(msg);
    	sm.addString("Current location : "+activeChar.getX()+", "+activeChar.getY()+", "+activeChar.getZ()+" ");
        sm.addZoneName(activeChar.getX(), activeChar.getY(), activeChar.getZ());
