...
public class MapRegionManager
{
    ...
    public Location getTeleToLocation(L2Character activeChar, TeleportWhereType teleportWhere)
    {
    	if (activeChar instanceof L2PcInstance)
    	{
            ...
            if (player.isInsideZone(ZoneType.DimensionalRift))
            {
                ...
                return DimensionalRiftManager.getInstance().getWaitingRoom().getRestartPoint(RestartType.RestartNormal);
            }
            
            
            if (player.isInsideZone(ZoneType.Arena))
            {
            	//TODO: G1ta0-> make arena respawn point
            	return new Location(player.getX(), player.getY(), player.getZ());
            }
            ...
            if (clan != null)
            {
                ...
                if (teleportWhere == TeleportWhereType.ClanHall)
                {
                    ...
                    if (clanhall != null)
                            return clanhall.getRestartPoint(RestartType.RestartOwner);
                    }
                ...
                if (teleportWhere == TeleportWhereType.Castle)
                {
                    ...
                    if (castle != null && castle.getSiege() != null && castle.getSiege().getIsInProgress())
                    {
                        ...
                        if (player.getKarma() > 1 || player.isCursedWeaponEquiped())
                           return castle.getRestartPoint(RestartType.RestartChaotic);
                        else
                           return castle.getRestartPoint(RestartType.RestartOwner);
                ...
                else if (teleportWhere == TeleportWhereType.SiegeFlag)
                {
                    ...
                    if (siege != null && siege.getCastle() != null && player.getSiegeState() == 1)
                    {
                        // Karma player respawns out of siege zone
                        if (player.getKarma() > 1 || player.isCursedWeaponEquiped())
                            return siege.getCastle().getRestartPoint(RestartType.RestartChaotic);
                        // get nearest flag
    ...
    //TODO: G1ta0 -> fix get area castle
