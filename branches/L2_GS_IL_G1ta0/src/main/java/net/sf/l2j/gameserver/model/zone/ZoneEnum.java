...
public final class ZoneEnum
{
	...
	public static enum RestartType
	{
		...
		public final static RestartType getRestartTypeEnum(String typeName)
		{
			for(RestartType rt : RestartType.values())
				if(rt.toString().equalsIgnoreCase("restart"+typeName))
					return rt;
