...
public final class RunnableStatsManager
{
	...
	private final Map<Class<?>, ClassStat> _classStats = FastMap.newInstance();
	...
	{
		if (_lastClassDump + 100 > System.currentTimeMillis())
			return;
		
		_lastClassDump = System.currentTimeMillis();
		
		try
		{
			BufferedWriter out =
				new BufferedWriter(new FileWriter("Class-" + System.currentTimeMillis() + ".log"));
