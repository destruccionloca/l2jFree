...
CREATE TABLE IF NOT EXISTS characters (
  ...
  nobless decimal(2,0) default 0,
  varka decimal(5,0) default 0,
  ketra decimal(5,0) default 0,
  equiped_with_zariche int(1) NOT NULL default '0',
  zariche_pk decimal(11,0) NOT NULL default '0',
  zariche_time decimal(20,0) NOT NULL default '0',
