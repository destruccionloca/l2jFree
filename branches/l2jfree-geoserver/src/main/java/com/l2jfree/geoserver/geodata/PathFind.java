...
public class PathFind
{
	...
	public PathFind(int x, int y, int z, int destX, int destY, int destZ, GeoInterface engine)
	{
		...
		startpoint = new Location(x - GeoConfig.MAP_MIN_X >> 4, y - GeoConfig.MAP_MIN_Y >> 4, z);
		endpoint = new Location(destX - GeoConfig.MAP_MIN_X >> 4, destY - GeoConfig.MAP_MIN_Y >> 4, destZ);
