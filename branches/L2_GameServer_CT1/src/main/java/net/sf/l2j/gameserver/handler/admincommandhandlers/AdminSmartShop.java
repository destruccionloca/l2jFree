...
public class AdminSmartShop implements IAdminCommandHandler
{
    ...
    private static int 	itemsStart 	=  0,
    					itemsEnd 	= -1,
    					weapnStart 	= -1,
    					weapnEnd 	= -1,
    					armorStart 	= -1,
    ...
    public boolean useAdminCommand(String command, L2PcInstance activeChar)
    {
        ...
        String 	mark	= (param.length > 1) ? param[1] : "",
        		title	= getTitle(mark),
        		message	= getMessage(mark);
    ...
    private String showMarkItems(String marks)
    {
    	...
    	for (int x = 0 ; x < maxId ; x += 3)
    	{
    		...
    		try
    		{
    			itemName1 = (ItemTable.getInstance().getTemplate(itemId[ x ]) == null) ? 
    					"<font color = \"FF0011\">(unknown)</font>" : 
    					ItemTable.getInstance().getTemplate(itemId[ x ]).getName();
    		}
    		catch(Throwable t)
    		{
    		...
    		try
    		{
    			itemName2 = (ItemTable.getInstance().getTemplate(itemId[x+1]) == null) ? 
    					"<font color = \"FF0011\">(unknown)</font>" : 
    					ItemTable.getInstance().getTemplate(itemId[x+1]).getName();
    		}
    		catch(Throwable t)
    		{
    		...
    		try
    		{
    			itemName3 = (ItemTable.getInstance().getTemplate(itemId[x+2]) == null) ? 
    					"<font color = \"FF0011\">(unknown)</font>" : 
    					(ItemTable.getInstance().getTemplate(itemId[x+2]).getName());
    		}
    		catch(Throwable t)
    		{
    		...
    		{
    			itemName1 = (itemName1.startsWith("<font color")) ?
    						("<font color = \"FF0000\"><br1>"+Integer.toString(itemId[ x ])+"<br1></font>") :
    					    ("<br1>"+Integer.toString(itemId[ x ])+"<br1>");
    			itemName2 = 
    				(!itemName2.equals("")) ?
    				
    						(itemName2.startsWith("<font color")) ?
    						("<font color = \"FF0000\"><br1>"+Integer.toString(itemId[x+1])+"<br1></font>") :
    						("<br1>"+Integer.toString(itemId[x+1])+"<br1>") : 
    						"";
    						
    			itemName3 = 
    				(!itemName3.equals("")) ?
    				
    						(itemName3.startsWith("<font color")) ?
    						("<font color = \"FF0000\"><br1>"+Integer.toString(itemId[x+2])+"<br1></font>") :
    						("<br1>"+Integer.toString(itemId[x+2])+"<br1>") :
    						"";
    		}
    		...
    		if (marks.contains("_gradeShow"))
    		{
    			...
    			itemName2 += (!itemName2.equals("")) ?
    						 ("<br1>Grade-"+getGradeString(gradeList.get(smartList.indexOf(itemId[x+1])).intValue())+"<br1>") : 
    						 "";
    			itemName3 += (!itemName3.equals("")) ?
    						 ("<br1>Grade-"+getGradeString(gradeList.get(smartList.indexOf(itemId[x+2])).intValue())+"<br1>") :
    						 "";
    						 
    		}

    		text += "<tr>" +
    				"<td width=\"100\"><a action=\"bypass -h admin_smartshop &&" + marks + " &&_get=" + itemId[ x ] + " && $input1 && $input2\"><font color = \"11DD00\">" + itemName1 + "</font></a></td>"; 
    		text += (!itemName2.equals("")) ? "<td width=\"100\"><a action=\"bypass -h admin_smartshop &&" + marks + " &&_get=" + itemId[x+1] + " && $input1 && $input2\"><font color = \"00FF00\">" + itemName2 + "</font></a></td>" : "<td width=\"100\"></td>";
    		text += (!itemName3.equals("")) ? "<td width=\"100\"><a action=\"bypass -h admin_smartshop &&" + marks + " &&_get=" + itemId[x+2] + " && $input1 && $input2\"><font color = \"00EE11\">" + itemName3 + "</font></a></td>" : "<td width=\"100\"></td>";
    		text += "</tr><br>";
    	}
    ...
    private int getStartIndex(String marks)
    {
    	...
    	int index = itemsStart,
    		endId = smartList.size(),
    		start = itemsStart,
    		view  = valueOfMark("_view" , marks);
    ...
    private int[] getMarkedItems(String marks, int i)
    {
    	...
    	{
    		int listSize = 
    			(marks.contains("_equip")) ? weapnEnd :
    			(marks.contains("_armor")) ? armorEnd :
    			(marks.contains("_weapn")) ? weapnEnd :
    			(marks.contains("_items")) ? itemsEnd : smartList.size();
    ...
    private List<Integer> getSearchItems(String marks, List<Integer> list)
    {
    	...
    	int view 		= valueOfMark("_view" , marks), 
    	    breakPoint 	= ((view > 0) ? view : _itemsPerView);
    	...
    	return (newList.size() <= ((view > 0) ? view : _itemsPerView)) ? 
    			newList : 
    			newList.subList((newList.size()-1)-((view > 0) ? view : _itemsPerView), newList.size());
    }
    ...
    String parseParam(String opCommand , String first , L2PcInstance actor)
    {
    	...
    	if (opCommand.contains("_armor") || opCommand.contains("_weapn") || opCommand.contains("_items") || opCommand.contains("_equip") || opCommand.contains("_ids"))
    	{
    ...
    private String getGrade(String grade)
    {
    	...
    	if (grade.equals("S") || grade.equals(L2Item.CRYSTAL_S))
    		...
    		return "D";
    	else if (grade.equals("N") || grade.equals("NO") || 
    			 grade.equals("NONE") || grade.equals(L2Item.CRYSTAL_NONE))
    		return "NONE";
    ...
    private String parseItemMarks(String mark , String[] param)
    {
        ...
        String newMark = param[2];
       	String opItemCmds[] = { 
       			"_getSkillItem=" , "_editItem=" , 
       			"_detailItem=" , "_getQuestItem=" , "_getBuyListItem=" };
    ...
    private String DetailItemText(int itemId)
    {
    	...
    	try
    	{
    		...
    		{
    		case L2Item.SLOT_ALLDRESS 	:	 	part = "All Dress" 		;	type = "Outfit"		; break;
    		case L2Item.SLOT_BABYPET  	: 		part = "Baby Pet" 		;	type = "Pet Item"	; 	break;
    		case L2Item.SLOT_BACK  		: 		part = "Back" 			;	type = "Outfit"		; break;
    		case L2Item.SLOT_CHEST 		: 		part = "Chest" 			;	type = "Armor"		; break;
    		case L2Item.SLOT_DECO		:		part = "Deco"			;	type = "Accessory"	; break;
    		case L2Item.SLOT_FEET		:		part = "Feet"			;	type = "Armor"		; break;
    		case L2Item.SLOT_FULL_ARMOR	:		part = "Full Armor"		;	type = "Armor"		; break;
    		case L2Item.SLOT_GLOVES		:		part = "Gloves"			;	type = "Armor"		; break;
    		case L2Item.SLOT_HAIR		:		part = "Hair Left"		;	type = "Accessory"	; break;
    		case L2Item.SLOT_HAIR2		:		part = "Hair Right"		;	type = "Accessory"	; break;
    		case L2Item.SLOT_HAIRALL	:		part = "Hair All"		;	type = "Accessory"	; break;
    		case L2Item.SLOT_HATCHLING	:		part = "Hatchling"		;	type = "Pet Item"	; break;
    		case L2Item.SLOT_HEAD		:		part = "Head"			;	type = "Armor"		; break;
    		case L2Item.SLOT_L_BRACELET	:		part = "Left Bracelet"	;	type = "Armor"		; break;
    		case L2Item.SLOT_L_EAR		:		part = "Left Ear"		;	type = "Jewelry"	; break;
    		case L2Item.SLOT_LEGS		:		part = "Legs"			;	type = "Armor"		; break;
    		case L2Item.SLOT_LR_EAR		:		part = "Ear(L/R)"		;	type = "Jewelry"	; break;
    		case L2Item.SLOT_L_FINGER	:		part = "Left Finger"	;	type = "Jewelry"	; break;
    		case L2Item.SLOT_L_HAND		:		part = "Left Hand"		;	type = "Shield"		; break;
    		case L2Item.SLOT_LR_FINGER	:		part = "Finger (L/R)"	;	type = "Jewelry"	; break;
    		case L2Item.SLOT_LR_HAND	:		part = "Both Hands"		;	type = "Weapon"		; break;
    		case L2Item.SLOT_NECK		:		part = "Neck"			;	type = "Jewelry"	; break;
    		case L2Item.SLOT_R_BRACELET	:		part = "Right Bracelet"	;	type = "Armor"		; break;
    		case L2Item.SLOT_R_EAR		:		part = "Right Ear"		;	type = "Jewelry"	; break;
    		case L2Item.SLOT_R_FINGER	:		part = "Right Finger"	;	type = "Jewelry"	; break;
    		case L2Item.SLOT_R_HAND		:		part = "Right Hand"		;	type = "Weapon"		; break;
    		case L2Item.SLOT_STRIDER	:		part = "Strider"		;	type = "Pet Item"	; break;
    		case L2Item.SLOT_UNDERWEAR	:		part = "Underwear"		;	type = "Armor"		; break;
    		case L2Item.SLOT_WOLF		:		part = "Wolf"			;	type = "Pet Item"	; break;
    		default						:		part = "None"			;	type = "Not Known"	; break;
    		}
    		String grade = "";
    		switch(item.getCrystalType())
    		{
    		case L2Item.CRYSTAL_S	:		grade = (item.getName().toLowerCase().contains("infinity")) ? "S Grade / Hero": "S Grade"; break;
    		case L2Item.CRYSTAL_A	:		grade = "A Grade"; break;
    		case L2Item.CRYSTAL_B	:		grade = "B Grade"; break;
    		case L2Item.CRYSTAL_C	:		grade = "C Grade"; break;
    		case L2Item.CRYSTAL_D	:		grade = "D Grade"; break;
    		default					: 		grade = "No Grade"; break;
    		}
    		...
    		{
    		case L2Item.MATERIAL_ADAMANTAITE	:	material = "Adamantaite";	break;
    		case L2Item.MATERIAL_BLOOD_STEEL	:	material = "Blood Steel";	break;
    		case L2Item.MATERIAL_BONE			:	material = "Bone"		;	break;
    		case L2Item.MATERIAL_BRONZE			:	material = "Bronze"		;	break;
    		case L2Item.MATERIAL_CHRYSOLITE		:	material = "Chrysolite"	;	break;
    		case L2Item.MATERIAL_CLOTH			:	material = "Cloth"		;	break;
    		case L2Item.MATERIAL_CRYSTAL		:	material = "Crystal"	;	break;
    		case L2Item.MATERIAL_DAMASCUS		:	material = "Damascus"	;	break;
    		case L2Item.MATERIAL_DYESTUFF		:	material = "Dye Stuff"	;	break;
    		case L2Item.MATERIAL_FINE_STEEL		:	material = "Fine Steel"	;	break;
    		case L2Item.MATERIAL_GOLD			:	material = "Gold"		;	break;
    		case L2Item.MATERIAL_HORN			:	material = "Horn"		;	break;
    		case L2Item.MATERIAL_LEATHER		:	material = "Leather"	;	break;
    		case L2Item.MATERIAL_LIQUID			:	material = "Liquid"		;	break;
    		case L2Item.MATERIAL_MITHRIL		:	material = "Mithril"	;	break;
    		case L2Item.MATERIAL_ORIHARUKON		:	material = "Oriharukon"	;	break;
    		case L2Item.MATERIAL_PAPER			:	material = "Paper"		;	break;
    		case L2Item.MATERIAL_SCALE_OF_DRAGON:	material = "Dragon Scale";	break;
    		case L2Item.MATERIAL_SEED			:	material = "Cob Web / Seed";break;
    		case L2Item.MATERIAL_SILVER			:	material = "Silver"		;	break;
    		case L2Item.MATERIAL_STEEL			:	material = "Steel"		;	break;
    		case L2Item.MATERIAL_WOOD			:	material = "Wood"		;	break;
    		}
    		...
    		message += (item.isForBabyPet()) ? "<br1> Baby Pet Item" : (item.isForHatchling() ? "<br1> Hatchling Pet Item" : 
    		...
    		if (item instanceof net.sf.l2j.gameserver.templates.L2Weapon)
    		{
    			...
    			try
    			{
    				message += (weapn.getChangeWeaponId() > 0) ? ("<br1>Exchange for   <a action=\"bypass -h admin_smartshop &&_get="+ weapn.getChangeWeaponId() +" &&_detailItem=" + weapn.getChangeWeaponId() + " && $input1 && $input2\"> " + ItemTable.getInstance().getTemplate(weapn.getChangeWeaponId()).getName() + " Id: " + weapn.getChangeWeaponId()) +" </a> " : "";
    			}
    			catch (Throwable t){}
    		}
