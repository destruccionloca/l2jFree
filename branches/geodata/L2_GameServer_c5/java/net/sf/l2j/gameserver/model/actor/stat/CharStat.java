...
public class CharStat
{
    ...
    public int getMAtkSpd()
    {
        ...
        if (Config.MAX_MATK_SPEED !=0 && val > Config.MAX_MATK_SPEED)
    ...
    { 
        double val = (calcStat(Stats.POWER_ATTACK_SPEED, getActiveChar().getTemplate().basePAtkSpd, null, null) / getActiveChar().getArmourExpertisePenalty());
        if (Config.MAX_PATK_SPEED !=0 && val > Config.MAX_PATK_SPEED)
