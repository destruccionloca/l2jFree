...
public class Potions implements IItemHandler
{
    private static int[] _itemIds = { 65, 725, 726, 727, 728, 734, 735, 1060, 1061, 1062,
                                      1374, 1375, 1539, 1540, 5283, 5591, 5592, 6035, 6036,
                                      6652, 6653, 6654, 6655, 8154, 8155, 8156, 8157 };
    ...
    public void useItem(L2PlayableInstance playable, L2ItemInstance item)
    {
        ...
        else if (itemId == 5283) // Rice Cake, xml: 2136
        {
            if (activeChar.getAllEffects() != null)
            {
                for (L2Effect e : activeChar.getAllEffects())
        ...
        // C5 Herbs TODO: Activate on Pickup
        else if (itemId == 8154) // Herb of Life
            res = usePotion(activeChar, 2244, 1);            
        else if (itemId == 8155) // Herb of Mana
            res = usePotion(activeChar, 2245, 1);            
        else if (itemId == 8156) // Herb of Power
            res = usePotion(activeChar, 2246, 1);            
        else if (itemId == 8157) // Herb of Magic
            res = usePotion(activeChar, 2247, 1);            
