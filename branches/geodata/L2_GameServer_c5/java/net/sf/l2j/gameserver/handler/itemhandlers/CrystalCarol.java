...
public class CrystalCarol implements IItemHandler
{
	private static int[] _itemIds = { 5562, 5563, 5564, 5565, 5566, 5583, 5584, 5585, 5586, 5587
									 ,4411, 4412, 4413, 4414, 4415, 4416, 4417, 5010, 7589, 7061, 7062 };
...
//			 playCrystalSound(activeChar,"SkillSound2.crystal_forgotten_song");
        ...
        /* TODO TEMP HACK FIND RIGHT ID */
         else if (itemId == 7061) { //crystal_forgotten_song
             MagicSkillUser MSU = new MagicSkillUser(playable, activeChar, 2073, 1, 1, 0);
             activeChar.broadcastPacket(MSU);
//               playCrystalSound(activeChar,"SkillSound2.crystal_forgotten_song");
             }
		 ...
		 activeChar.broadcastPacket(MSU);
//			 playCrystalSound(activeChar,"SkillSound2.crystal_birthday");
		 }		
