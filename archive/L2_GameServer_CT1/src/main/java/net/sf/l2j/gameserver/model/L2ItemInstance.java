	...
	*/
	...
	public boolean isAvailable(L2PcInstance player, boolean allowAdena)
	{
		return ((!isEquipped()) // Not equipped
				...
				&& (player.getCurrentSkill() == null || player.getCurrentSkill().getSkill().getItemConsumeId() != getItemId()) && (isTradeable()));
	}
	...
	*/
	...
	public boolean canBeAttrEnchanted(int element)
	{
		if (_log.isDebugEnabled())
			_log.debug("ae_element " + ae_enchantElement + " compare to " + element);
