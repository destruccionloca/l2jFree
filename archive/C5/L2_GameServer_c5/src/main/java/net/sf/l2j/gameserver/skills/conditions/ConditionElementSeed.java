...
//        if (Config.DEVELOPER) _log.debugr("Required seeds: " + _requiredSeeds[0] + ", " + _requiredSeeds[1] + ", " + _requiredSeeds[2]+ ", " + _requiredSeeds[3]+ ", " + _requiredSeeds[4]);
    }
...
//        if (Config.DEVELOPER) _log.debugr("Seeds: " + Seeds[0] + ", " + Seeds[1] + ", " + Seeds[2]);
