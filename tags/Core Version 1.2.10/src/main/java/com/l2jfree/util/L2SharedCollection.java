 ...
 * @author NB4L1
 */
public final class L2SharedCollection<T extends L2Object> implements L2Collection<T>
{
	private final Map<Integer, T> _map = new SingletonMap<Integer, T>().setShared();
