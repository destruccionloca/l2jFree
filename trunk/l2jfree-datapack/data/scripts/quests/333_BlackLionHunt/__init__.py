    ...
    if event == "start" :
      ...
      if st.getQuestItemsCount(CARGO_BOX1) :
        if st.getQuestItemsCount(ADENA_ID)>=OPEN_BOX_PRICE:
          ...
          if random < 21 :
            st.giveItems(GLUDIO_APPLE,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(CORN_MEAL,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(WOLF_PELTS,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(MONNSTONE,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(GLUDIO_WEETS_FLOWER,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(SPIDERSILK_ROPE,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(ALEXANDRIT,int(Config.RATE_QUESTS_REWARD_ITEMS))
            return html+redfoot+standart+back+htmlend
          elif random < 109:
            st.giveItems(SILVER_TEA,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(GOLEM_PART,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(FIRE_EMERALD,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(SILK_FROCK,int(Config.RATE_QUESTS_REWARD_ITEMS))
            ...
            st.giveItems(PORCELAN_URN,int(Config.RATE_QUESTS_REWARD_ITEMS))
            return html+redfoot+standart+back+htmlend
          elif random < 132:
            st.giveItems(IMPERIAL_DIAMOND,int(Config.RATE_QUESTS_REWARD_ITEMS))
