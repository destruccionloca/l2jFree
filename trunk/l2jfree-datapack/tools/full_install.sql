DROP TABLE IF EXISTS account_data,armor,armorsets,auction,auction_bid,auction_lots,
                     ...
                     character_friends,
                     character_hennas,character_macroses,character_quest_global_data,character_quests,
                     character_recipebook,character_recommends,character_shortcuts,character_skills,
                     character_skills_save,character_subclasses,character_tpbookmark,characters,clan_data,
                     ...
                     skill_learn,skill_residential,skill_spellbooks,skill_trees,spawnlist,special_skill_trees,
		     teleport,topic,transform_skill_trees,walker_routes,weapon;

DROP TABLE IF EXISTS buff_templates,
                     character_blocks,
                     character_raidpoints,couples,ctf,ctf_teams,
