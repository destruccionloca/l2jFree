...
public final class Connection
{
    ...
    final L2GameClient _client;
    
    // Connection used by Selector Thread (nio)
    public Connection(L2GameClient client, Socket socket, byte[] cryptKey)
    {
        _client = client;
        _csocket = socket;        
    ...
    public Connection(L2GameClient client, AsyncSocketChannel asc, byte[] cryptKey)
    {
        _client = client;
        _csocket = asc.socket();        
        _chanell = null;
