...
//    }
//
//	public static ClientBasePacket handlePacket(ByteBuffer data, L2GameClient client)
//	{
...
//				break;
//			case 0x1a: // request power gradelist
//				msg = new DummyPacket(data, client, id);
//				break;
//			case 0x1b://pledge member power info ??
//				msg = new RequestSocialAction(data, client);
//				break;
//			case 0x1c: // set member power grade ?
//				msg = new ChangeMoveType2(data, client);
//				break;
//			case 0x1d: // pledgememberinfo ?
...
//			break;
//			case 0x23: // requestcreatepledge cs 23 
//				msg = new DummyPacket(data,client, id);
//				break;
//			case 0x24:
...
//				_log.warn("Unknown Packet 0x" + Integer.toHexString(id) + " from " + client.getActiveChar());
