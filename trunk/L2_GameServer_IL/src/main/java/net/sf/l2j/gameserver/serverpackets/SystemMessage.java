...
public class SystemMessage extends ServerBasePacket
{
    ...
    public static final int PET_SUMMON_NOT_WHILE_TRADE = 577;
    public static final int PET_SUMMON_NOT_WHILE_BATTLE = 578;
    public static final int PET_UNSUMMON_NOT_WHILE_BATTLE = 579;
    public static final int PET_INVENTORY_FULL = 588;
    public static final int PET_UNSUMMON_NOT_WHILE_DEAD = 589;
    public static final int PET_GIVE_NOT_WHILE_DEAD = 590;
