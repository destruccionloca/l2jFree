...
('Town of Giran -> Hunter\'s Village', 27, 116819, 76994, -2714, 4100, 0),
...
('Ivoryv Tower Basement', 31, 84915, 15969, -4294, 0, 0),
('Ivoryv Tower Ground Floor', 32, 85399, 16197, -3679, 0, 0),
('Ivoryv Tower 1st Floor', 33, 85399, 16197, -2809, 0, 0),
('Ivoryv Tower 2nd Floor', 34, 85399, 16197, -2293, 0, 0),
('Ivoryv Tower 3th Floor', 35, 85399, 16197, -1776, 0, 0),
('Ivoryv Tower Ground Floor -> Oren Castle Town', 36, 82956, 53162, -1495, 4400, 0),
('Ivoryv Tower Ground Floor -> Hunter\'s Village', 37, 116819, 76994, -2714, 8200, 0),
('Ivoryv Tower Ground Floor -> Aden Castle Town', 38, 146331, 25762, -2018, 12000, 0),
...
('Hunter\'s -> Northern Pathway of Enchanted Valley', 99, 104426, 33746, -3800, 3600, 0),
('Hunter\'s -> Southern Pathway of Enchanted Valley', 100, 124904, 61992, -3920, 1300, 0),
('Hunter\'s -> Entrance to the Forest of Mirrors', 101, 142065, 81300, -3000, 2000, 0),
('Hunter\'s -> The Front of Anghel Waterfall', 102, 163341, 91374, -3320, 4000, 0),
...
('Innadril(artifact -> out)', 421, 116046, 247094, -930, 0, 0),
('Innadril(artifact -> hall)', 422, 116028, 249163, -787, 0, 0),
('Innadril(artifact -> outofcastle)', 423, 116373, 244729, -1059, 0, 0),
('Innadril(hall -> artifact)', 424, 116028, 250136, -867, 0, 0),
('Innadril(hall -> out)', 425, 116046, 247094, -930, 0, 0),
('Innadril(hall -> outofcastle)', 426, 116373, 244729, -1059, 0, 0),
('Innadril(out -> artifact)', 427, 116028, 250136, -867, 0, 0),
('Innadril(out -> hall)', 428, 116028, 249163, -787, 0, 0),
('Innadril(out -> outofcastle)', 429, 116373, 244729, -1059, 0, 0),
('Innadril(outofcastle -> artifact)', 430, 116028, 250136, -867, 0, 0),
('Innadril(outofcastle -> out)', 431, 116046, 247094, -930, 0, 0),
('Innadril(outofcastle -> hall)', 432, 116028, 249163, -787, 0, 0),
('Goddard(artifact -> out)', 433, 147466, -48514, -2085, 0, 0),
('Goddard(artifact -> hall)', 434, 147463, -48504, -2277, 0, 0),
('Goddard(artifact -> outofcastle)', 435, 147265, -44908, -2085, 0, 0),
('Goddard(hall -> artifact)', 436, 146165, -50478, -1604, 0, 0),
('Goddard(hall -> out)', 437, 147466, -48514, -2085, 0, 0),
('Goddard(hall -> outofcastle)', 438, 147265, -44908, -2085, 0, 0),
('Goddard(out -> artifact)', 439, 146165, -50478, -1604, 0, 0),
('Goddard(out -> hall)', 440, 147463, -48504, -2277, 0, 0),
('Goddard(out -> outofcastle)', 441, 147265, -44908, -2085, 0, 0),
('Goddard(outofcastle -> artifact)', 442, 146165, -50478, -1604, 0, 0),
('Goddard(outofcastle -> out)', 443, 147466, -48514, -2085, 0, 0),
('Goddard(outofcastle -> hall)', 444, 147463, -48504, -2277, 0, 0),
...
('Rune(artifact -> out)', 501, 16981, -49170, -1098, 0, 0),
('Rune(artifact -> hall)', 502, 11729, -49154, -537, 0, 0),
('Rune(artifact -> outofcastle)', 503, 19049, -49141, -1258, 0, 0),
('Rune(hall -> artifact)', 504, 9913, -49164, 996, 0, 0),
('Rune(hall -> out)', 505, 16981, -49170, -1098, 0, 0),
('Rune(hall -> outofcastle)', 506, 19049, -49141, -1258, 0, 0),
('Rune(out -> artifact)', 507, 9913, -49164, 996, 0, 0),
('Rune(out -> hall)', 508, 11729, -49154, -537, 0, 0),
('Rune(out -> outofcastle)', 509, 19049, -49141, -1258, 0, 0),
('Rune(outofcastle -> artifact)', 510, 9913, -49164, 996, 0, 0),
('Rune(outofcastle -> out)', 511, 16981, -49170, -1098, 0, 0),
('Rune(outofcastle -> hall)', 512, 11729, -49154, -537, 0, 0),
('Schuttgard(artifact -> out)', 513, 77501, -149943, -353, 0, 0),
('Schuttgard(artifact -> hall)', 514, 77547, -152461, -545, 0, 0),
('Schuttgard(artifact -> outofcastle)', 515, 77562, -149119, -353, 0, 0),
('Schuttgard(hall -> artifact)', 516, 77557, -154975, 387, 0, 0),
('Schuttgard(hall -> out)', 517, 77501, -149943, -353, 0, 0),
('Schuttgard(hall -> outofcastle)', 518, 77562, -149119, -353, 0, 0),
('Schuttgard(out -> artifact)', 519, 77557, -154975, 387, 0, 0),
('Schuttgard(out -> hall)', 520, 77547, -152461, -545, 0, 0),
('Schuttgard(out -> outofcastle)', 521, 77562, -149119, -353, 0, 0),
('Schuttgard(outofcastle -> artifact)', 522, 77557, -154975, 387, 0, 0),
('Schuttgard(outofcastle -> out)', 523, 77501, -149943, -353, 0, 0),
('Schuttgard(outofcastle -> hall)', 524, 77547, -152461, -545, 0, 0),
...
('Hunter\'s Valley - 1000 adena', 9028, 114306, 86573, -3112, 1000, 0),
...
('Hunter\'s Valley - 1000 adena', 9032, 114306, 86573, -3112, 1000, 0),
...
('Hunter\'s Valley - 1 Noble Gate Pass', 9928, 114306, 86573, -3112, 1, 1),
...
('Hunter\'s Valley - 1 Noble Gate Pass', 9932, 114306, 86573, -3112, 1, 1),
