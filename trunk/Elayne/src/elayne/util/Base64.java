...
/**
 * Encodes and decodes to and from Base64 notation. The source is based on the
 * work of Robert Harder
 * <p>
...
public class Base64
{
	...
	{ (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I', (byte) 'J', (byte) 'K', (byte) 'L', (byte) 'M', (byte) 'N', (byte) 'O', (byte) 'P',
							(byte) 'Q', (byte) 'R', (byte) 'S', (byte) 'T', (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z', (byte) 'a', (byte) 'b', (byte) 'c', (byte) 'd',
							(byte) 'e', (byte) 'f', (byte) 'g', (byte) 'h', (byte) 'i', (byte) 'j', (byte) 'k', (byte) 'l', (byte) 'm', (byte) 'n', (byte) 'o', (byte) 'p', (byte) 'q', (byte) 'r',
							(byte) 's', (byte) 't', (byte) 'u', (byte) 'v', (byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4', (byte) '5',
	...
	static
	{
		...
		{
			__bytes = _NATIVE_ALPHABET; // Fall back to
			// native encoding
		} // end catch
		ALPHABET = __bytes;
	} // end static
	...
	// /**
	// * Encodes the first three bytes of array
	// <var>threeBytes</var>
	...
	// <var>threeBytes</var>
	// * and returns a four-byte array in Base64 notation.
	// * The actual number of significant bytes in your
	// array is
	// * given by <var>numSigBytes</var>.
	// * The array <var>threeBytes</var> needs only be as
	// big as
	// * <var>numSigBytes</var>.
	// *
	// * @param threeBytes the array to convert
	// * @param numSigBytes the number of significant bytes
	// in your array
	// * @return four byte array in Base64 notation.
	// * @since 1.3
	// */
	...
	static byte[] encode3to4(byte[] source, int srcOffset, int numSigBytes, byte[] destination, int destOffset)
	{
		...
		// --------000000001111111122222222 Array position
		// from threeBytes
		...
		// Create buffer with zero-padding if there are only
		// one or two
		// significant bytes passed in the array.
		// We have to shift left 24 in order to flush out
		// the 1's that appear
		// when Java treats a value as negative that is cast
		// from a byte to an
		// int.
	...
	public static String encodeBytes(byte[] source, int off, int len, int options)
	{
		...
		// Convert option to boolean in way that code likes
		// it.
	...
	// /**
	// * Decodes the first four bytes of array
	// <var>fourBytes</var>
	// * and returns an array up to three bytes long with
	// the
	// * decoded values.
	// *
	...
	public static byte[] decode(byte[] source, int off, int len)
	{
		...
		for (i = off; i < off + len; i++)
		{
			...
			} // end if: white space, equals sign or
			// better
			else
			{
	...
	public static byte[] decode(String s)
	{
		...
		if (bytes.length >= 2)
		{
			...
			if (bytes != null && // In case decoding
									// returned null
									bytes.length >= 4 && // Don't
									// want
									// to
									// get
	...
	public static class InputStream extends java.io.FilterInputStream
	{
		...
		// converted data
		private int bufferLength; // Length of buffer (3
		// or 4)
		private int numSigBytes; // Number of meaningful
		// bytes in the buffer
		private int lineLength;
		private boolean breakLines; // Break lines at less
		...
		public int read() throws java.io.IOException
		{
			...
			// When JDK1.4 is more accepted, use an
			// assertion here.
