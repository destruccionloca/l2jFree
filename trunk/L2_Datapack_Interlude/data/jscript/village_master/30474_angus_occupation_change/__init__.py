 ...
 def onTalk (Self,npc,st):
   ...
   if npcId in [GRAND_MASTER_ANGUS,GRAND_MASTER_BRECSON,GRAND_MASTER_MEDOWN,GRAND_MASTER_OLTLIN,GRAND_MASTER_XAIRAKIN,31324,31285,31331,31334] and Race in [Race.darkelf]:
     if ClassId in [ClassId.palusKnight]:
       ...
       st.exitQuest(1)
       return "30474-54.htm"
     elif ClassId in [ClassId.spellhowler, ClassId.shillienElder, ClassId.phantomSummoner]:
       st.setState(COMPLETED)
       st.exitQuest(1)
       return "30474-54.htm"
...
for i in [31328,30195,30699,30474,31324,30862,30175,30910,31285,31331,31334]:
    QUEST.addStartNpc(i)
    STARTED.addTalkId(i)
