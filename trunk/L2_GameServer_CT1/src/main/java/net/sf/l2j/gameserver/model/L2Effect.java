...
public abstract class L2Effect
{
	...
	{
		BUFF, CHARGE, DMG_OVER_TIME, HEAL_OVER_TIME, COMBAT_POINT_HEAL_OVER_TIME, MANA_DMG_OVER_TIME, MANA_HEAL_OVER_TIME, RELAXING, STUN, ROOT, SLEEP, HATE, FAKE_DEATH, CONFUSION, CONFUSE_MOB_ONLY, MUTE, FEAR, SILENT_MOVE, SEED, PARALYZE, STUN_SELF, BLUFF, BETRAY, NOBLESSE_BLESSING, PETRIFICATION, CANCEL_TARGET, SILENCE_MAGIC_PHYSICAL, ERASE, PETRIFIED, LUCKNOBLESSE, PSYCHICAL_MUTE, TARGET_ME, REMOVE_TARGET, BATTLE_FORCE, SPELL_FORCE, CHARM_OF_LUCK, INVINCIBLE, PHEONIX_SOUL, BAND_OF_DARKNESS, DARK_SEED, TRANSFORM, DISARM, PREVENT_BUFF, CONDITION_HIT
	}
	 ...
	 * <li>Stop the task of the L2Effect, remove it and update client magic icone </li>
	 * <BR>
	 * <BR>
	 */
	 ...
	 * <li>Stop and remove L2Effect from L2Character and update client magic icone </li>
	 * <BR>
	 * <BR>
	 */
