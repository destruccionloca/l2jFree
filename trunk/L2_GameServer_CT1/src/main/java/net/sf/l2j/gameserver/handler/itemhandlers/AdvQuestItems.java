...
public class AdvQuestItems implements IItemHandler
{
    ...
    private static final int AWARD_GBOOK[] = {
        5942, 5943, 5945, 5946, 5947, 5948, 5949, 5950, 5951, 5952, 
        5953, 5954
    };
    
    private static final int AWARD_PAPY1[] = {
        5970, 5971, 5977, 5978, 5979, 5986, 5993, 5994, 5995, 5997, 
        5983, 6001
    };
    
    private static final int AWARD_PAPY2[] = {
        5970, 5971, 5975, 5976, 5980, 5985, 5993, 5994, 5995, 5997, 
        5983, 6001
    };
    
    private static final int AWARD_PAPY3[] = {
        5973, 5974, 5981, 5984, 5989, 5990, 5991, 5992, 5996, 5998, 
        5999, 6000, 5988, 5983, 6001
    };
    
    private static final int AWARD_PAPY4[] = {
        5970, 5971, 5982, 5987, 5989, 5990, 5991, 5992, 5996, 5998, 
        5999, 6000, 5972, 6001
    };
