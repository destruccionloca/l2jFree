...
REM jython
REM SET CLASSPATH=%CLASSPATH%;./lib/jython-2.2.1.jar
REM SET CLASSPATH=%CLASSPATH%;./lib/jython-engine-1.0.1.jar

REM SET CLASSPATH=%CLASSPATH%;./lib/bsf-2.0.jar
REM SET CLASSPATH=%CLASSPATH%;./lib/bsh-2.0b5.jar
REM SET CLASSPATH=%CLASSPATH%;./lib/bsh-engine-1.0.1.jar
REM SET CLASSPATH=%CLASSPATH%;./lib/core-3.3.0.jar
REM SET CLASSPATH=%CLASSPATH%;./lib/java-engine-1.0.2.jar
...
REM For IRC use
REM SET CLASSPATH=%CLASSPATH%;./lib/irclib-1.10.jar
