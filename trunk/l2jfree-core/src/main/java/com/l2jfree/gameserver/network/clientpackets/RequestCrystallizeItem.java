...
public class RequestCrystallizeItem extends L2GameClientPacket
{
	...
	private final static Log _log = LogFactory.getLog(RequestCrystallizeItem.class.getName());
	...
	protected void runImpl()
	{
		...
		if (_count <= 0)
		{
			Util.handleIllegalPlayerAction(activeChar, "[RequestCrystallizeItem] count <= 0! ban! oid: "
							+ _objectId + " owner: " + activeChar.getName(), IllegalPlayerAction.PUNISH_KICK);
			return;
		}
