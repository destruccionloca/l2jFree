...
public class GeoEngine extends GeoData
{
	...
	// Public Methods
	/**
	 * @see com.l2jfree.gameserver.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#getSpawnHeight(int, int, int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#canSeeTarget(com.l2jfree.gameserver.model.L2Object, com.l2jfree.gameserver.model.L2Object)
	 */
	@Override
	...
	/**
	* @see com.l2jfree.gameserver.GeoData#canSeeTarget(L2Object, Point3D)
	*/
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#canSeeTargetDebug(com.l2jfree.gameserver.model.actor.instance.L2PcInstance, com.l2jfree.gameserver.model.L2Object)
	 */
	@Override
	public boolean canSeeTargetDebug(L2PcInstance gm, L2Object target)
	{
		...
		if (gm.getZ() >= target.getZ())
			return canSeeDebug(gm, (gm.getX() - L2World.MAP_MIN_X) >> 4, (gm.getY() - L2World.MAP_MIN_Y) >> 4, z, (target.getX() - L2World.MAP_MIN_X) >> 4,
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see com.l2jfree.gameserver.GeoData#moveCheck(int, int, int, int, int, int)
	 */
	@Override
	public Location moveCheck(int x, int y, int z, int tx, int ty, int tz)
	{
		...
		return moveCheck(startpoint, destiny, (x - L2World.MAP_MIN_X) >> 4, (y - L2World.MAP_MIN_Y) >> 4, z, (tx - L2World.MAP_MIN_X) >> 4,
				(ty - L2World.MAP_MIN_Y) >> 4, tz);
	}

	/**
	 * @see com.l2jfree.gameserver.GeoData#addGeoDataBug(com.l2jfree.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * Creates points for line of sight check (x,y,z towards target) and in each point, layer and movement checks are made with NLOS function.
	 * 
