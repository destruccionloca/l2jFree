...
def render_shop(mode,item) :
    ...
    if mode == "list" :
       ...
       html += "<tr><td align=left><font color=\"LEVEL\">Item Information</font></td><td align=right><a action=\"bypass -h Quest 373_SupplierOfReagents buy\">Back</a></td><td width=5><br></td></tr></table><table border=0 bgcolor=\"000000\" width=500 height=160><tr><td valign=top><table border=0><tr><td valign=top width=35><img src=icon."+ITEMS[item][0]+" width=32 height=32 align=left></td><td valign=top width=400><table border=0 width=100%><tr><td><font color=\"FFFFFF\">"+ITEMS[item][1]+" x"+str(SHOP_LIST[item][0])+"</font></td></tr><tr><td><font color=\"B09878\">"+ITEMS[item][2]+"</font></td></tr></table></td></tr></table><br><font color=\"LEVEL\">Item Required:</font><table border=0 bgcolor=\"000000\" width=500 height=120><tr><td valign=top><table border=0><tr><td valign=top width=35><img src=icon."+ITEMS[SHOP_LIST[item][1]][0]+" width=32 height=32 align=left></td><td valign=top width=400><table border=0 width=100%><tr><td><font color=\"FFFFFF\">"+ITEMS[SHOP_LIST[item][1]][1]+" x"+str(SHOP_LIST[item][2])+"</font></td></tr><tr><td><font color=\"B09878\">"+ITEMS[SHOP_LIST[item][1]][2]+"</font></td></tr></table></td></tr></table><br><table border=0 width=300><tr><td align=center><a action=\"bypass -h Quest 373_SupplierOfReagents "+str(item)+"\">Exchange</a></td></tr></table></td></tr></table></td></tr>"
...
def render_urn(st, page) :
    ...
    if page == "Start" :
       ...
       for i in MATS :
          html += "<tr><td height=45><img src=icon."+ITEMS[i][0]+" height=32 width=32></td><td>"+ITEMS[i][1]+"</td><td><a action=\"bypass -h Quest 373_SupplierOfReagents x_1_"+page[1]+"_"+str(i)+"\">X1</a></td><td><a action=\"bypass -h Quest 373_SupplierOfReagents x_2_"+page[1]+"_"+str(i)+"\">X10</a></td></tr>"
